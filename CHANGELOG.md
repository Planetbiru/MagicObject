...
Added support for converting table structures between **MySQL**, **PostgreSQL**, and **SQLite**.  
This feature is especially useful for database **migration** scenarios where compatibility and portability are required across different RDBMS platforms.
