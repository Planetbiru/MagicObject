...
class PicoDatabaseDump
{
     ...
     * from either a single entity or an array of entities. The method delegates the generation of 
     * queries to different helper methods depending on whether a single entity or multiple entities 
     * are provided.
     *
     * @param MagicObject|MagicObject[] $entity A single entity or an array of entities representing the columns to be added. Each entity contains the column name, type, and other related information.
     * @param PicoDatabase|null $database The database connection used to fetch the current table schema. If null, the default database will be used.
     * @param bool $createIfNotExists Flag indicating whether a CREATE TABLE query should be generated if the table does not exist. Default is false.
     * @param bool $dropIfExists Flag indicating whether a DROP TABLE query should be generated if the table already exists, before the CREATE TABLE query. Default is false.
     * @param bool $forceCreateNewTable Flag indicating whether to force the creation of columns even if they already exist. Default is false.
     * 
     ...
     * the necessary ALTER TABLE queries. If columns already exist in the database, they will be skipped unless
     * the forceCreateNewTable flag is set to true, in which case the columns will be created even if they exist.
     *
     * @param MagicObject[] $entities An array of entity objects representing the columns to be added. Each entity contains the column name, type, and other related information.
     * @param string|null $tableName The name of the table to alter. If null, the table name is derived from the entities.
     * @param PicoDatabase|null $database The database connection used to fetch the current table schema. If null, it will be inferred from the entities.
     * @param bool $createIfNotExists Flag to indicate if a CREATE TABLE query should be generated if the table does not exist. Default is false.
     * @param bool $dropIfExists Flag to indicate if a DROP TABLE query should be generated if the table already exists, before the CREATE TABLE query. Default is false.
     * @param bool $forceCreateNewTable Flag to force the creation of columns even if they already exist in the database. Default is false.
     * 
     * @return string[] An array of SQL ALTER TABLE queries to add the columns. Each query is a string representing a complete ALTER TABLE statement.
     */
     ...
     *
     * This method generates SQL ALTER TABLE queries to add new columns to a table based on the 
     * provided entity. It checks the current database schema and compares it with the entity's 
     * column definitions, generating queries for columns that do not already exist in the database. 
     * The method can also force the creation of columns, even if they already exist, based on the 
     * `forceCreateNewTable` flag.
     *
     * @param MagicObject $entity The entity representing the table and its columns to be added.
     * @param bool $forceCreateNewTable Flag indicating whether to force the creation of columns 
     *                                  even if they already exist in the database. Default is false.
     * 
     * @return string[] An array of SQL ALTER TABLE queries to add the columns. Each query is a string 
     *                  representing a complete ALTER TABLE statement.
     */
